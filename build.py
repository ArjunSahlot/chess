...
print("Installing...")
try:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/chess/archive/main.zip", tmp)
    file += "main"
except urllib.error.HTTPError:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/chess/archive/master.zip", tmp)
    file += "master"
